...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $connection = mysqli_connect('awseb-e-ccnmsqhepk-stack-awsebrdsdatabase-w0hjmlkwsq41.cbeu2m0uuauu.us-east-1.rds.amazonaws.com', 'uts', 'utsuts123', 'assignment1'); // servername, username, password, db_name
